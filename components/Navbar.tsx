...
<nav className='navbar navbar-expand-lg main-purple' aria-label='Navbar'>
    <div className='container-fluid'>
        ...
        <button className='navbar-toggler border-0 justify-content-start' type='button' data-bs-toggle="collapse"
            data-bs-target="#navbar1" aria-controls="navbar1" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div className='collapse navbar-collapse' id='navbar1'>
            <ul className='navbar-nav col-lg-4 me-auto mb-2 mb-lg-0 gap-4'>
                ...
                <li className='nav-item dropdown'>
                    <Link href="#" className='nav-link dropdown-toggle text-white' role='button' id='drop-01'
            ...
            <form role='search' className='input-group justify-content-lg-center deep-purple rounded'>
                <input id="search-bar" type="search" className='form-control form-control-lg border-0 text-white'
                    placeholder='Enter your search here...' aria-label="Search" />
